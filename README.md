...
| Project 3 | 11 (11 active in manifest) |
| Project 4 | 0 |
...
| chatgpt_autogenerated_{0} | These are testcases autogenerated by ChatGPT, with some manual fixes. They can be hit or miss with regards to their utility in debugging/testing. |
