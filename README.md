...
| double_erase | Tries to erase a word twice. Insanity is the only testcase that covers this thus far so I created this testcase since it is easier to isolate the problem and debug.
...
| Mihir | 2 | integer_limits_open_for_integers, integer_limits_ordered_for_integers |
