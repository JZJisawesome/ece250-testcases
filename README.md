...
| Project 3 | 15 (15 active in manifest) |
| Project 4 | 0 |
...
| Contributor | Number Of Testcases Contributed | Testcase Names |
|-------------|---------------------------------|----------------|
| ChatGPT (with manual fixes) | 1 | chatgpt_autogenerated_0 |
| ECE 250 Teaching Staff | 4 | LEARN_test01, LEARN_test01, LEARN_test02, LEARN_test03 |
| John Jekel (JZJ) | 8 | alphabetic_print, dont_erase_too_much, invalid, long_words, multiload, sanity, spellcheck_correct, spellcheck_incorrect |
