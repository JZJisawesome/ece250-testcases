...
| Project 3 | 21 (21 active in manifest) |
| Project 4 | 0 |
...
| dont_erase_too_much | Erases words and ensure you don't accidentally erase other ones by mistake. Also makes sure your size variable remains consistent with the number of words present. |
...
| John Jekel (JZJ) | 14 | alphabetic_print, dont_erase_too_much, im_empty_inside, invalid, long_words, more_spellchecking, multiload, prefix_example_from_spec, prefix_peril, sanity, spellcheck_correct, spellcheck_example_from_spec, spellcheck_no_suggestions, spellcheck_incorrect |
