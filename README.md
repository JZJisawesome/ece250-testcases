...
| Project 2 | 17 (16 active in manifest) |
| Project 3 | 0 |
| Project 4 | 0 |
...
| Contributor | Number Of Testcases Contributed | Testcase Names |
|-------------|---------------------------------|-------|
| ChatGPT (with manual fixes) | 3 | chatgpt_autogenerated_0, chatgpt_autogenerated_1 |
...
| John Jekel (JZJ) | 6 | insanity_open, insanity_ordered, respect_capacity_open, respect_capacity_ordered, sanity_open, sanity_ordered |
